...
export class CartouchesService {
...
downloadFile(data, filename='data') {
  ...
  let csvData = this.ConvertToCSV(data, ['idCartouche','type', 'qteInitiale', 'qteRestante',
   'dateAppro', 'staff', 'typeImprim', 'userName']);
...
return this.http.get(url+"/listCartouche", {headers : headers});
}
